...
export class LeverAdapter {
    ...
    extractCompany(document, url, leverData) {
    ...
    extractRole(document, leverData) {
        // Try embedded data first
        if (leverData?.title) {
    ...
    extractLocation(document, leverData) {
        // Try embedded data first
    ...
    extractDepartment(document, leverData) {
        // Try embedded data first
        if (leverData?.team) {
