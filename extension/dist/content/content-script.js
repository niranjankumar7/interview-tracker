...
import { generateFingerprint } from '../shared/dedupe.js';
import { startExtractionTracking, trackSave, trackDuplicate } from '../shared/telemetry.js';
 ...
 */
async function trackSaveAction(wasEdited, fieldsEdited, domain, adapter, confidence) {
