...
*See [Archived Initial Walkthrough](./initial_walkthrough.md) for full details.*
...
![Clarivate Flow Success](./media/clarivate_flow_success_1770498013354.png)
...
- **Actual**: System incorrectly updated the existing **"Meta — Software Engineer"** application to "Interview" status, ignoring the explicit role change to SDET.
- **Impact**: Data corruption (wrong role updated) and confusion for users applying to multiple roles at the same company.
![Meta Bug Reproduction](./media/meta_bug_reproduction_1770498055448.png)
...
![Multi-Action Result](./media/test_case_1_result_1770498106069.png)
...
![Context Switching Result](./media/test_case_3_result_1770498170918.png)

---

## 4. Final Pipeline Verification
**Status: VERIFIED**
The final state of the pipeline board confirms the test results:
- **Clarivate**: Correctly in **Rejected** column (from Test Case 1).
- **Meta**: Incorrectly moved to **Interview** column with "Software Engineer" role (confirming the Bug from Test Case 2).

![Final Pipeline Board State](./media/pipeline_status_check_1770498422815.png)
