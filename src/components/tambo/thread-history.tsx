...
>(({ ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "flex items-center rounded-md mb-4 hover:bg-muted transition-colors cursor-pointer relative",
  ...
  return (
    <div ref={ref} className={cn("mb-4 relative", className)} {...props}>
      ...
      <button
        ...
        className={cn(
          "p-1 hover:bg-muted rounded-md cursor-pointer absolute left-1/2 -translate-x-1/2",
          isCollapsed
      ...
      >
        ...
        <input
          ref={searchInputRef}
          type="text"
          className="pl-10 pr-4 py-2 w-full text-sm rounded-md bg-muted/50 focus:outline-none"
          placeholder="Search..."
          value={searchQuery}
      ...
      <div className="space-y-1">
        {filteredThreads.map((thread: TamboThread) => (
          <div
            ...
            className={cn(
              "p-2 rounded-md hover:bg-muted/50 cursor-pointer group flex items-center justify-between",
